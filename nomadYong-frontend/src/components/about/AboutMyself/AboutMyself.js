...
const AboutMyself = () => (
  <div className={cx('about-myself')}>
    ...
    <div className={cx('paper')}>
      ...
      <p>
      I studied Computer Science at Kyungpook National University. When I was in school, I was interested in web development and artificial intelligence, so I studied intensively.
      </p>
      <p>
      ...
      <p>
        When I’m not working I still code some of my personal projects. Programming is more than just a work for me, this is a hobby, it’s a passion. But if I’m not in front of a computer I pass all my time with my beautiful girl friend 😃.
      </p>
